...
resource "vault_pki_secret_backend_key" "pki_openstack_postgres_intermediate" {
  ...
  key_name = "openstack-postgres-intermediate-${count.index}"
}
...
resource "vault_pki_secret_backend_role" "pki_openstack_postgres_intermediate_user_glance" {
  backend             = vault_mount.pki_openstack_postgres_intermediate.path
  name                = "user-glance"
  issuer_ref          = "default"
  ttl                 = "7776000" # 90 days
...
resource "vault_pki_secret_backend_role" "pki_openstack_postgres_intermediate_user_cinder" {
  backend             = vault_mount.pki_openstack_postgres_intermediate.path
  name                = "user-cinder"
  issuer_ref          = "default"
  ttl                 = "7776000" # 90 days
...
resource "vault_pki_secret_backend_role" "pki_openstack_postgres_intermediate_user_placement" {
  backend             = vault_mount.pki_openstack_postgres_intermediate.path
  name                = "user-placement"
  issuer_ref          = "default"
  ttl                 = "7776000" # 90 days
...
resource "vault_pki_secret_backend_role" "pki_openstack_postgres_intermediate_user_nova" {
  ...
  max_ttl             = "7776000"
  allow_ip_sans       = false
  allowed_domains     = ["nova-api", "nova-cell0", "nova-cell1"]
  allow_bare_domains  = true
  allow_subdomains    = false
  enforce_hostnames   = false
  server_flag         = false
...
resource "vault_pki_secret_backend_role" "pki_openstack_postgres_intermediate_user_octavia" {
  backend             = vault_mount.pki_openstack_postgres_intermediate.path
  name                = "user-octavia"
  issuer_ref          = "default"
  ttl                 = "7776000" # 90 days
