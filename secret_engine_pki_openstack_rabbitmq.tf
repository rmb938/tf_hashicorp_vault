...
resource "vault_pki_secret_backend_issuer" "pki_openstack_rabbitmq_intermediate" {
  count = local.pki_openstack_rabbitmq_intermediates

  backend     = vault_mount.pki_openstack_rabbitmq_intermediate.path
  issuer_ref  = vault_pki_secret_backend_intermediate_set_signed.pki_openstack_rabbitmq_intermediate[local.pki_openstack_rabbitmq_intermediates - 1].imported_issuers[0]
  issuer_name = "openstack-rabbitmq-intermediate-${count.index}"
...
resource "vault_pki_secret_backend_role" "pki_openstack_rabbitmq_intermediate_server" {
  backend       = vault_mount.pki_openstack_rabbitmq_intermediate.path
  name          = "server"
  issuer_ref    = "default"
  ttl           = "7776000" # 90 days
...
resource "vault_pki_secret_backend_role" "pki_openstack_rabbitmq_intermediate_user_cinder" {
  backend             = vault_mount.pki_openstack_rabbitmq_intermediate.path
  name                = "user-cinder"
  issuer_ref          = "default"
  ttl                 = "7776000" # 90 days
...
resource "vault_pki_secret_backend_role" "pki_openstack_rabbitmq_intermediate_user_neutron" {
  backend             = vault_mount.pki_openstack_rabbitmq_intermediate.path
  name                = "user-neutron"
  issuer_ref          = "default"
  ttl                 = "7776000" # 90 days
...
resource "vault_pki_secret_backend_role" "pki_openstack_rabbitmq_intermediate_user_neutron_compute" {
  backend             = vault_mount.pki_openstack_rabbitmq_intermediate.path
...
resource "vault_pki_secret_backend_role" "pki_openstack_rabbitmq_intermediate_user_nova_controller" {
  backend             = vault_mount.pki_openstack_rabbitmq_intermediate.path
  name                = "user-nova-controller"
  issuer_ref          = "default"
  ttl                 = "7776000" # 90 days
  max_ttl             = "7776000"
  allow_ip_sans       = false
  allowed_domains     = ["nova-controller"]
  allow_bare_domains  = true
  allow_subdomains    = false
  enforce_hostnames   = false
  server_flag         = false
...
resource "vault_pki_secret_backend_role" "pki_openstack_rabbitmq_intermediate_user_nova_compute" {
  backend             = vault_mount.pki_openstack_rabbitmq_intermediate.path
  name                = "user-nova-compute"
  issuer_ref          = "default"
  ttl                 = "7776000" # 90 days
  max_ttl             = "7776000"
  allow_ip_sans       = false
  allowed_domains     = ["nova-compute"]
  allow_bare_domains  = true
  allow_subdomains    = false
  enforce_hostnames   = false
  server_flag         = false
...
resource "vault_pki_secret_backend_role" "pki_openstack_rabbitmq_intermediate_user_octavia" {
  backend             = vault_mount.pki_openstack_rabbitmq_intermediate.path
  name                = "user-octavia"
  issuer_ref          = "default"
  ttl                 = "7776000" # 90 days
